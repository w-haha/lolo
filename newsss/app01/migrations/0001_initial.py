# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2018-11-06 10:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='content',
            name='type_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='context', to='app01.Type', verbose_name='新闻类型'),
        ),
        migrations.AddField(
            model_name='content',
            name='user_id',
        ...
        migrations.AddField(
            model_name='comment',
            name='news_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Content', verbose_name='新闻'),
        ),
        migrations.AddField(
            model_name='comment',
            name='restore',
